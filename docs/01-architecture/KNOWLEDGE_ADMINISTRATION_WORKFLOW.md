...
| No in-process durable worker or external retrieval sandbox is shipped. | `ARCHITECTURAL_DEFICIENCY` | Jobs persist queue/retry/cancel state but require a separately deployed SYSTEM worker. |
