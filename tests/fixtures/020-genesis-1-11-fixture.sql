...
INSERT INTO entity (entity_key, entity_type_code, canonical_name) VALUES
    ...
    ('gen1_creatures', 'CONCEPT', 'living creatures'),
    ('gen1_birds', 'CONCEPT', 'birds'),
    ('gen1_land_creatures', 'CONCEPT', 'land creatures'),
    ('gen1_mankind', 'CONCEPT', 'mankind');
...
INSERT INTO event (event_key, event_type_code, description) VALUES
    ...
    ('gen1_20_creatures_command_statement', 'OTHER', 'Genesis 1:20 water-creatures/birds-command statement.'),
    ('gen1_21_creatures_statement', 'OTHER', 'Genesis 1:21 water-creatures/birds statement; the evaluative statement is intentionally excluded.'),
    ('gen1_24_land_creatures_command_statement', 'OTHER', 'Genesis 1:24 land-creatures-command statement; kind/subtype categories are intentionally not modeled as separate entities.'),
    ('gen1_25_land_creatures_statement', 'OTHER', 'Genesis 1:25 land-creatures statement; kind/subtype categories and the evaluative statement are intentionally excluded.'),
    ('gen1_26_mankind_command_statement', 'OTHER', 'Genesis 1:26 mankind-command statement; image, likeness, and dominion language is intentionally excluded.'),
...
FROM (VALUES ('adam', 'parentIn', 'seth_begetting'), ('seth', 'childIn', 'seth_begetting'),
             ...
             ('gen1_god', 'subjectOf', 'gen1_20_creatures_command_statement'),
             ('gen1_creatures', 'participatesIn', 'gen1_20_creatures_command_statement'),
             ('gen1_birds', 'participatesIn', 'gen1_20_creatures_command_statement'),
             ('gen1_waters', 'participatesIn', 'gen1_20_creatures_command_statement'),
             ('gen1_god', 'subjectOf', 'gen1_21_creatures_statement'),
             ('gen1_creatures', 'participatesIn', 'gen1_21_creatures_statement'),
             ('gen1_birds', 'participatesIn', 'gen1_21_creatures_statement'),
             ('gen1_waters', 'participatesIn', 'gen1_21_creatures_statement'),
             ('gen1_god', 'subjectOf', 'gen1_24_land_creatures_command_statement'),
             ('gen1_land_creatures', 'participatesIn', 'gen1_24_land_creatures_command_statement'),
...
FROM (VALUES
        ...
        ('gen1_god', 'subjectOf', 'gen1_20_creatures_command_statement', 'CLAIM_MT_GEN_1_20_GOD_CREATURES_COMMAND_SUBJECT',
         'Genesis 1:20 presents God as the subject of a water-creatures/birds-command statement.'),
        ('gen1_creatures', 'participatesIn', 'gen1_20_creatures_command_statement', 'CLAIM_MT_GEN_1_20_CREATURES_COMMAND_PARTICIPANT',
         'Genesis 1:20 presents living creatures within the water-creatures/birds-command statement.'),
        ('gen1_birds', 'participatesIn', 'gen1_20_creatures_command_statement', 'CLAIM_MT_GEN_1_20_BIRDS_COMMAND_PARTICIPANT',
         'Genesis 1:20 presents birds within the water-creatures/birds-command statement.'),
        ('gen1_waters', 'participatesIn', 'gen1_20_creatures_command_statement', 'CLAIM_MT_GEN_1_20_WATERS_COMMAND_PARTICIPANT',
         'Genesis 1:20 presents the waters within the water-creatures/birds-command statement.'),
        ('gen1_god', 'subjectOf', 'gen1_21_creatures_statement', 'CLAIM_MT_GEN_1_21_GOD_CREATURES_SUBJECT',
         'Genesis 1:21 presents God as the subject of a water-creatures/birds statement. The evaluative statement is intentionally excluded.'),
        ('gen1_creatures', 'participatesIn', 'gen1_21_creatures_statement', 'CLAIM_MT_GEN_1_21_CREATURES_PARTICIPANT',
         'Genesis 1:21 presents living creatures within the water-creatures/birds statement.'),
        ('gen1_birds', 'participatesIn', 'gen1_21_creatures_statement', 'CLAIM_MT_GEN_1_21_BIRDS_PARTICIPANT',
         'Genesis 1:21 presents birds within the water-creatures/birds statement.'),
        ('gen1_waters', 'participatesIn', 'gen1_21_creatures_statement', 'CLAIM_MT_GEN_1_21_WATERS_PARTICIPANT',
         'Genesis 1:21 presents the waters within the water-creatures/birds statement.'),
        ('gen1_god', 'subjectOf', 'gen1_24_land_creatures_command_statement', 'CLAIM_MT_GEN_1_24_GOD_LAND_CREATURES_COMMAND_SUBJECT',
         'Genesis 1:24 presents God as the subject of a land-creatures-command statement. Kind/subtype categories are intentionally not modeled as separate entities.'),
        ('gen1_land_creatures', 'participatesIn', 'gen1_24_land_creatures_command_statement', 'CLAIM_MT_GEN_1_24_LAND_CREATURES_COMMAND_PARTICIPANT',
         'Genesis 1:24 presents land creatures within the land-creatures-command statement.'),
        ('gen1_god', 'subjectOf', 'gen1_25_land_creatures_statement', 'CLAIM_MT_GEN_1_25_GOD_LAND_CREATURES_SUBJECT',
         'Genesis 1:25 presents God as the subject of a land-creatures statement. Kind/subtype categories and the evaluative statement are intentionally excluded.'),
...
FROM (VALUES
        ...
        ('MT_GEN_1_20', 'EV_MT_GEN_1_20_CREATURES_COMMAND',
         'Genesis 1:20 is represented as a structural source-record boundary that presents God, living creatures, birds, and the waters within a water-creatures/birds-command statement.'),
        ('MT_GEN_1_21', 'EV_MT_GEN_1_21_CREATURES',
         'Genesis 1:21 is represented as a structural source-record boundary that presents God, living creatures, birds, and the waters within a water-creatures/birds statement. The evaluative statement is intentionally excluded.'),
        ('MT_GEN_1_22', 'EV_MT_GEN_1_22_EXCLUDED',
         'Genesis 1:22 is represented as a structural source-record boundary for a blessing/multiplication statement. Blessing and multiplication semantics are intentionally not modeled in this phase; only the source-record boundary and citation are recorded.'),
        ('MT_GEN_1_23', 'EV_MT_GEN_1_23_EXCLUDED',
         'Genesis 1:23 is represented as a structural source-record boundary for a day-boundary statement (fifth day). Ordinal day and temporal vocabulary are intentionally not modeled in this phase; only the source-record boundary and citation are recorded.'),
        ('MT_GEN_1_24', 'EV_MT_GEN_1_24_LAND_CREATURES_COMMAND',
         'Genesis 1:24 is represented as a structural source-record boundary that presents God and land creatures within a land-creatures-command statement. Kind/subtype categories are intentionally not modeled as separate entities.'),
        ('MT_GEN_1_25', 'EV_MT_GEN_1_25_LAND_CREATURES',
         'Genesis 1:25 is represented as a structural source-record boundary that presents God and land creatures within a land-creatures statement. Kind/subtype categories and the evaluative statement are intentionally excluded.'),
        ('MT_GEN_1_26', 'EV_MT_GEN_1_26_MANKIND_COMMAND',
         'Genesis 1:26 is represented as a structural source-record boundary that presents God and mankind within a mankind-command statement. Image, likeness, and dominion language is intentionally excluded.'),
        ('MT_GEN_1_27', 'EV_MT_GEN_1_27_MANKIND_CREATION',
         'Genesis 1:27 is represented as a structural source-record boundary that presents God and mankind within a mankind-creation statement. Image, likeness, and male/female language is intentionally excluded.'),
        ('MT_GEN_1_28', 'EV_MT_GEN_1_28_EXCLUDED',
         'Genesis 1:28 is represented as a structural source-record boundary for a blessing/multiplication/dominion statement. These semantics are intentionally not modeled in this phase; only the source-record boundary and citation are recorded.'),
        ('MT_GEN_1_29', 'EV_MT_GEN_1_29_EXCLUDED',
         'Genesis 1:29 is represented as a structural source-record boundary for a food-provision statement. Food/nutrition semantics are intentionally not modeled in this phase; only the source-record boundary and citation are recorded.'),
        ('MT_GEN_1_30', 'EV_MT_GEN_1_30_EXCLUDED',
         'Genesis 1:30 is represented as a structural source-record boundary for a food-provision statement to animals. Food/nutrition semantics are intentionally not modeled in this phase; only the source-record boundary and citation are recorded.'),
        ('MT_GEN_1_31', 'EV_MT_GEN_1_31_EXCLUDED',
         'Genesis 1:31 is represented as a structural source-record boundary for an evaluative statement and a day-boundary statement (sixth day). Evaluative and ordinal-day/temporal semantics are intentionally not modeled in this phase; only the source-record boundary and citation are recorded.'),
...
FROM (VALUES
        ...
        ('CLAIM_MT_GEN_1_19_DAY_BOUNDARY_SUBJECT', 'EV_MT_GEN_1_19_DAY_BOUNDARY', 'SUPPORTS',
         'The claim records the source-presented subject role without asserting the ordinal day count.'),
        ('CLAIM_MT_GEN_1_20_GOD_CREATURES_COMMAND_SUBJECT', 'EV_MT_GEN_1_20_CREATURES_COMMAND', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_20_CREATURES_COMMAND_PARTICIPANT', 'EV_MT_GEN_1_20_CREATURES_COMMAND', 'SUPPORTS',
         'The claim records living creatures as directly present in the water-creatures/birds-command statement.'),
        ('CLAIM_MT_GEN_1_20_BIRDS_COMMAND_PARTICIPANT', 'EV_MT_GEN_1_20_CREATURES_COMMAND', 'SUPPORTS',
         'The claim records birds as directly present in the water-creatures/birds-command statement.'),
        ('CLAIM_MT_GEN_1_20_WATERS_COMMAND_PARTICIPANT', 'EV_MT_GEN_1_20_CREATURES_COMMAND', 'SUPPORTS',
         'The claim records the waters as directly present in the water-creatures/birds-command statement.'),
        ('CLAIM_MT_GEN_1_21_GOD_CREATURES_SUBJECT', 'EV_MT_GEN_1_21_CREATURES', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_21_CREATURES_PARTICIPANT', 'EV_MT_GEN_1_21_CREATURES', 'SUPPORTS',
         'The claim records living creatures as directly present in the water-creatures/birds statement.'),
        ('CLAIM_MT_GEN_1_21_BIRDS_PARTICIPANT', 'EV_MT_GEN_1_21_CREATURES', 'SUPPORTS',
         'The claim records birds as directly present in the water-creatures/birds statement.'),
        ('CLAIM_MT_GEN_1_21_WATERS_PARTICIPANT', 'EV_MT_GEN_1_21_CREATURES', 'SUPPORTS',
         'The claim records the waters as directly present in the water-creatures/birds statement.'),
        ('CLAIM_MT_GEN_1_24_GOD_LAND_CREATURES_COMMAND_SUBJECT', 'EV_MT_GEN_1_24_LAND_CREATURES_COMMAND', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_24_LAND_CREATURES_COMMAND_PARTICIPANT', 'EV_MT_GEN_1_24_LAND_CREATURES_COMMAND', 'SUPPORTS',
         'The claim records land creatures as directly present in the land-creatures-command statement.'),
        ...
        ('CLAIM_MT_GEN_1_26_GOD_MANKIND_COMMAND_SUBJECT', 'EV_MT_GEN_1_26_MANKIND_COMMAND', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_26_MANKIND_COMMAND_PARTICIPANT', 'EV_MT_GEN_1_26_MANKIND_COMMAND', 'SUPPORTS',
         'The claim records mankind as directly present in the mankind-command statement.'),
        ('CLAIM_MT_GEN_1_27_GOD_MANKIND_CREATION_SUBJECT', 'EV_MT_GEN_1_27_MANKIND_CREATION', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_27_MANKIND_CREATION_PARTICIPANT', 'EV_MT_GEN_1_27_MANKIND_CREATION', 'SUPPORTS',
         'The claim records mankind as directly present in the mankind-creation statement.'),
