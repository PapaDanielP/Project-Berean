...
JOIN (VALUES
        ...
        ('GEN_MT_REF', 'MT_GEN_1_20', 'Genesis 1:20'),
        ('GEN_MT_REF', 'MT_GEN_1_21', 'Genesis 1:21'),
        ('GEN_MT_REF', 'MT_GEN_1_22', 'Genesis 1:22'),
        ('GEN_MT_REF', 'MT_GEN_1_23', 'Genesis 1:23'),
        ('GEN_MT_REF', 'MT_GEN_1_24', 'Genesis 1:24'),
        ('GEN_MT_REF', 'MT_GEN_1_25', 'Genesis 1:25'),
        ('GEN_MT_REF', 'MT_GEN_1_26', 'Genesis 1:26'),
        ('GEN_MT_REF', 'MT_GEN_1_27', 'Genesis 1:27'),
        ('GEN_MT_REF', 'MT_GEN_1_28', 'Genesis 1:28'),
        ('GEN_MT_REF', 'MT_GEN_1_29', 'Genesis 1:29'),
        ('GEN_MT_REF', 'MT_GEN_1_30', 'Genesis 1:30'),
...
INSERT INTO entity (entity_key, entity_type_code, canonical_name) VALUES
    ...
    ('gen1_waters_creatures', 'CONCEPT', 'waters creatures'),
    ('gen1_birds', 'CONCEPT', 'birds'),
    ('gen1_great_sea_creatures', 'CONCEPT', 'great sea creatures'),
...
INSERT INTO event (event_key, event_type_code, description) VALUES
    ...
    ('gen1_20_waters_birds_statement', 'OTHER', 'Genesis 1:20 waters-and-birds statement; multiplication language is intentionally excluded.'),
    ('gen1_21_creatures_birds_statement', 'OTHER', 'Genesis 1:21 creatures-and-birds statement; kind language is intentionally excluded.'),
    ('gen1_22_waters_birds_statement', 'OTHER', 'Genesis 1:22 waters-and-birds statement; blessing and multiplication semantics are intentionally excluded.'),
    ('gen1_23_day_boundary_statement', 'OTHER', 'Genesis 1:23 day-boundary statement; ordinal day count is intentionally unresolved.'),
    ('gen1_24_land_creatures_statement', 'OTHER', 'Genesis 1:24 land-creatures statement; taxonomy language is intentionally excluded.'),
    ('gen1_25_land_creatures_statement', 'OTHER', 'Genesis 1:25 land-creatures statement; kind language and evaluative language are intentionally excluded.'),
    ('gen1_26_humankind_statement', 'OTHER', 'Genesis 1:26 humankind statement; image/likeness and dominion semantics are intentionally excluded.'),
    ('gen1_27_humankind_statement', 'OTHER', 'Genesis 1:27 humankind statement; image semantics and male/female distinctions are intentionally excluded.'),
    ('gen1_28_humankind_statement', 'OTHER', 'Genesis 1:28 humankind statement; blessing, multiplication, and dominion semantics are intentionally excluded.'),
    ('gen1_29_food_provision_statement', 'OTHER', 'Genesis 1:29 food-provision statement; nutritional semantics are intentionally excluded.'),
    ('gen1_30_creature_food_statement', 'OTHER', 'Genesis 1:30 creature-food statement; taxonomy and nutritional semantics are intentionally excluded.'),
    ('gen1_31_completion_statement', 'OTHER', 'Genesis 1:31 completion statement; evaluative language is intentionally excluded.');
...
FROM (VALUES ('adam', 'parentIn', 'seth_begetting'), ('seth', 'childIn', 'seth_begetting'),
             ...
             ('gen1_day', 'subjectOf', 'gen1_19_day_boundary_statement'),
             ('gen1_god', 'subjectOf', 'gen1_20_waters_birds_statement'),
             ('gen1_waters_creatures', 'participatesIn', 'gen1_20_waters_birds_statement'),
             ('gen1_birds', 'participatesIn', 'gen1_20_waters_birds_statement'),
             ('gen1_god', 'subjectOf', 'gen1_21_creatures_birds_statement'),
             ('gen1_great_sea_creatures', 'participatesIn', 'gen1_21_creatures_birds_statement'),
             ('gen1_birds', 'participatesIn', 'gen1_21_creatures_birds_statement'),
             ('gen1_god', 'subjectOf', 'gen1_22_waters_birds_statement'),
             ('gen1_waters_creatures', 'participatesIn', 'gen1_22_waters_birds_statement'),
             ('gen1_birds', 'participatesIn', 'gen1_22_waters_birds_statement'),
             ('gen1_day', 'subjectOf', 'gen1_23_day_boundary_statement'),
             ('gen1_god', 'subjectOf', 'gen1_24_land_creatures_statement'),
             ('gen1_land_creatures', 'participatesIn', 'gen1_24_land_creatures_statement'),
             ('gen1_god', 'subjectOf', 'gen1_25_land_creatures_statement'),
             ('gen1_land_creatures', 'participatesIn', 'gen1_25_land_creatures_statement'),
             ('gen1_god', 'subjectOf', 'gen1_26_humankind_statement'),
             ('gen1_humankind', 'participatesIn', 'gen1_26_humankind_statement'),
             ('gen1_god', 'subjectOf', 'gen1_27_humankind_statement'),
             ('gen1_humankind', 'participatesIn', 'gen1_27_humankind_statement'),
             ('gen1_god', 'subjectOf', 'gen1_28_humankind_statement'),
             ('gen1_humankind', 'participatesIn', 'gen1_28_humankind_statement'),
             ('gen1_god', 'subjectOf', 'gen1_29_food_provision_statement'),
             ('gen1_humankind', 'participatesIn', 'gen1_29_food_provision_statement'),
             ('gen1_vegetation', 'participatesIn', 'gen1_29_food_provision_statement'),
             ('gen1_god', 'subjectOf', 'gen1_30_creature_food_statement'),
             ('gen1_land_creatures', 'participatesIn', 'gen1_30_creature_food_statement'),
             ('gen1_birds', 'participatesIn', 'gen1_30_creature_food_statement'),
             ('gen1_green_plants', 'participatesIn', 'gen1_30_creature_food_statement'),
             ('gen1_god', 'subjectOf', 'gen1_31_completion_statement'),
             ('gen1_all_made', 'participatesIn', 'gen1_31_completion_statement')) AS m(subject_key, predicate, event_key)
JOIN entity s ON s.entity_key = m.subject_key
...
FROM (VALUES
        ...
        ('gen1_god', 'subjectOf', 'gen1_20_waters_birds_statement', 'CLAIM_MT_GEN_1_20_GOD_WATERS_BIRDS_SUBJECT',
        'Genesis 1:20 presents God as the subject of a waters-and-birds statement. Multiplication language is intentionally excluded.'),
        ('gen1_waters_creatures', 'participatesIn', 'gen1_20_waters_birds_statement', 'CLAIM_MT_GEN_1_20_WATERS_CREATURES_PARTICIPANT',
        'Genesis 1:20 presents waters creatures within the waters-and-birds statement.'),
        ('gen1_birds', 'participatesIn', 'gen1_20_waters_birds_statement', 'CLAIM_MT_GEN_1_20_BIRDS_PARTICIPANT',
        'Genesis 1:20 presents birds within the waters-and-birds statement.'),
        ('gen1_god', 'subjectOf', 'gen1_21_creatures_birds_statement', 'CLAIM_MT_GEN_1_21_GOD_CREATURES_BIRDS_SUBJECT',
        'Genesis 1:21 presents God as the subject of a creatures-and-birds statement. Kind language is intentionally excluded.'),
        ('gen1_great_sea_creatures', 'participatesIn', 'gen1_21_creatures_birds_statement', 'CLAIM_MT_GEN_1_21_GREAT_SEA_CREATURES_PARTICIPANT',
        'Genesis 1:21 presents great sea creatures within the creatures-and-birds statement.'),
        ('gen1_birds', 'participatesIn', 'gen1_21_creatures_birds_statement', 'CLAIM_MT_GEN_1_21_BIRDS_PARTICIPANT',
        'Genesis 1:21 presents birds within the creatures-and-birds statement.'),
        ('gen1_god', 'subjectOf', 'gen1_22_waters_birds_statement', 'CLAIM_MT_GEN_1_22_GOD_WATERS_BIRDS_SUBJECT',
        'Genesis 1:22 presents God as the subject of a waters-and-birds statement. Blessing and multiplication semantics are intentionally excluded.'),
        ('gen1_waters_creatures', 'participatesIn', 'gen1_22_waters_birds_statement', 'CLAIM_MT_GEN_1_22_WATERS_CREATURES_PARTICIPANT',
        'Genesis 1:22 presents waters creatures within the waters-and-birds statement.'),
        ('gen1_birds', 'participatesIn', 'gen1_22_waters_birds_statement', 'CLAIM_MT_GEN_1_22_BIRDS_PARTICIPANT',
        'Genesis 1:22 presents birds within the waters-and-birds statement.'),
        ('gen1_day', 'subjectOf', 'gen1_23_day_boundary_statement', 'CLAIM_MT_GEN_1_23_DAY_BOUNDARY_SUBJECT',
        'Genesis 1:23 presents day as the subject of a day-boundary statement. The ordinal day count is intentionally unresolved.'),
        ('gen1_god', 'subjectOf', 'gen1_24_land_creatures_statement', 'CLAIM_MT_GEN_1_24_GOD_LAND_CREATURES_SUBJECT',
        'Genesis 1:24 presents God as the subject of a land-creatures statement. Taxonomy language is intentionally excluded.'),
        ('gen1_land_creatures', 'participatesIn', 'gen1_24_land_creatures_statement', 'CLAIM_MT_GEN_1_24_LAND_CREATURES_PARTICIPANT',
        'Genesis 1:24 presents land creatures within the land-creatures statement.'),
        ('gen1_god', 'subjectOf', 'gen1_25_land_creatures_statement', 'CLAIM_MT_GEN_1_25_GOD_LAND_CREATURES_SUBJECT',
        'Genesis 1:25 presents God as the subject of a land-creatures statement. Kind language and evaluative language are intentionally excluded.'),
        ('gen1_land_creatures', 'participatesIn', 'gen1_25_land_creatures_statement', 'CLAIM_MT_GEN_1_25_LAND_CREATURES_PARTICIPANT',
        'Genesis 1:25 presents land creatures within the land-creatures statement.'),
        ('gen1_god', 'subjectOf', 'gen1_26_humankind_statement', 'CLAIM_MT_GEN_1_26_GOD_HUMANKIND_SUBJECT',
        'Genesis 1:26 presents God as the subject of a humankind statement. Image/likeness and dominion semantics are intentionally excluded.'),
        ('gen1_humankind', 'participatesIn', 'gen1_26_humankind_statement', 'CLAIM_MT_GEN_1_26_HUMANKIND_PARTICIPANT',
        'Genesis 1:26 presents humankind within the humankind statement.'),
        ('gen1_god', 'subjectOf', 'gen1_27_humankind_statement', 'CLAIM_MT_GEN_1_27_GOD_HUMANKIND_SUBJECT',
        'Genesis 1:27 presents God as the subject of a humankind statement. Image semantics and male/female distinctions are intentionally excluded.'),
        ('gen1_humankind', 'participatesIn', 'gen1_27_humankind_statement', 'CLAIM_MT_GEN_1_27_HUMANKIND_PARTICIPANT',
        'Genesis 1:27 presents humankind within the humankind statement.'),
        ('gen1_god', 'subjectOf', 'gen1_28_humankind_statement', 'CLAIM_MT_GEN_1_28_GOD_HUMANKIND_SUBJECT',
        'Genesis 1:28 presents God as the subject of a humankind statement. Blessing, multiplication, and dominion semantics are intentionally excluded.'),
        ('gen1_humankind', 'participatesIn', 'gen1_28_humankind_statement', 'CLAIM_MT_GEN_1_28_HUMANKIND_PARTICIPANT',
        'Genesis 1:28 presents humankind within the humankind statement.'),
        ('gen1_god', 'subjectOf', 'gen1_29_food_provision_statement', 'CLAIM_MT_GEN_1_29_GOD_FOOD_PROVISION_SUBJECT',
        'Genesis 1:29 presents God as the subject of a food-provision statement. Nutritional semantics are intentionally excluded.'),
        ('gen1_humankind', 'participatesIn', 'gen1_29_food_provision_statement', 'CLAIM_MT_GEN_1_29_HUMANKIND_PARTICIPANT',
        'Genesis 1:29 presents humankind within the food-provision statement.'),
        ('gen1_vegetation', 'participatesIn', 'gen1_29_food_provision_statement', 'CLAIM_MT_GEN_1_29_VEGETATION_PARTICIPANT',
        'Genesis 1:29 presents vegetation within the food-provision statement.'),
        ('gen1_god', 'subjectOf', 'gen1_30_creature_food_statement', 'CLAIM_MT_GEN_1_30_GOD_CREATURE_FOOD_SUBJECT',
        'Genesis 1:30 presents God as the subject of a creature-food statement. Taxonomy and nutritional semantics are intentionally excluded.'),
        ('gen1_land_creatures', 'participatesIn', 'gen1_30_creature_food_statement', 'CLAIM_MT_GEN_1_30_LAND_CREATURES_PARTICIPANT',
        'Genesis 1:30 presents land creatures within the creature-food statement.'),
        ('gen1_birds', 'participatesIn', 'gen1_30_creature_food_statement', 'CLAIM_MT_GEN_1_30_BIRDS_PARTICIPANT',
        'Genesis 1:30 presents birds within the creature-food statement.'),
        ('gen1_green_plants', 'participatesIn', 'gen1_30_creature_food_statement', 'CLAIM_MT_GEN_1_30_GREEN_PLANTS_PARTICIPANT',
        'Genesis 1:30 presents green plants within the creature-food statement.'),
        ('gen1_god', 'subjectOf', 'gen1_31_completion_statement', 'CLAIM_MT_GEN_1_31_GOD_COMPLETION_SUBJECT',
        'Genesis 1:31 presents God as the subject of a completion statement. Evaluative language is intentionally excluded.'),
        ('gen1_all_made', 'participatesIn', 'gen1_31_completion_statement', 'CLAIM_MT_GEN_1_31_ALL_MADE_PARTICIPANT',
        'Genesis 1:31 presents all made within the completion statement.')
...
FROM (VALUES
        ...
        ('MT_GEN_1_20', 'EV_MT_GEN_1_20_WATERS_BIRDS',
         'Genesis 1:20 is represented as a structural source-record boundary that presents God, waters creatures, and birds within a waters-and-birds statement. Multiplication language is intentionally excluded.'),
        ('MT_GEN_1_21', 'EV_MT_GEN_1_21_CREATURES_BIRDS',
         'Genesis 1:21 is represented as a structural source-record boundary that presents God, great sea creatures, and birds within a creatures-and-birds statement. Kind language is intentionally excluded.'),
        ('MT_GEN_1_22', 'EV_MT_GEN_1_22_WATERS_BIRDS',
         'Genesis 1:22 is represented as a structural source-record boundary that presents God, waters creatures, and birds within a waters-and-birds statement. Blessing and multiplication semantics are intentionally excluded.'),
        ('MT_GEN_1_23', 'EV_MT_GEN_1_23_DAY_BOUNDARY',
         'Genesis 1:23 is represented as a structural source-record boundary that presents day within a day-boundary statement. The ordinal day count is intentionally excluded.'),
        ('MT_GEN_1_24', 'EV_MT_GEN_1_24_LAND_CREATURES',
         'Genesis 1:24 is represented as a structural source-record boundary that presents God and land creatures within a land-creatures statement. Taxonomy language is intentionally excluded.'),
        ('MT_GEN_1_25', 'EV_MT_GEN_1_25_LAND_CREATURES',
         'Genesis 1:25 is represented as a structural source-record boundary that presents God and land creatures within a land-creatures statement. Kind language and evaluative language are intentionally excluded.'),
        ('MT_GEN_1_26', 'EV_MT_GEN_1_26_HUMANKIND',
         'Genesis 1:26 is represented as a structural source-record boundary that presents God and humankind within a humankind statement. Image/likeness and dominion semantics are intentionally excluded.'),
        ('MT_GEN_1_27', 'EV_MT_GEN_1_27_HUMANKIND',
         'Genesis 1:27 is represented as a structural source-record boundary that presents God and humankind within a humankind statement. Image semantics and male/female distinctions are intentionally excluded.'),
        ('MT_GEN_1_28', 'EV_MT_GEN_1_28_HUMANKIND',
         'Genesis 1:28 is represented as a structural source-record boundary that presents God and humankind within a humankind statement. Blessing, multiplication, and dominion semantics are intentionally excluded.'),
        ('MT_GEN_1_29', 'EV_MT_GEN_1_29_FOOD_PROVISION',
         'Genesis 1:29 is represented as a structural source-record boundary that presents God, humankind, and vegetation within a food-provision statement. Nutritional semantics are intentionally excluded.'),
        ('MT_GEN_1_30', 'EV_MT_GEN_1_30_CREATURE_FOOD',
         'Genesis 1:30 is represented as a structural source-record boundary that presents God, land creatures, birds, and green plants within a creature-food statement. Taxonomy and nutritional semantics are intentionally excluded.'),
        ('MT_GEN_1_31', 'EV_MT_GEN_1_31_COMPLETION',
         'Genesis 1:31 is represented as a structural source-record boundary that presents God and all made within a completion statement. Evaluative language is intentionally excluded.'),
...
FROM (VALUES
        ...
        ('CLAIM_MT_GEN_1_19_DAY_BOUNDARY_SUBJECT', 'EV_MT_GEN_1_19_DAY_BOUNDARY', 'SUPPORTS',
         'The claim records the source-presented subject role without asserting the ordinal day count.'),
        ('CLAIM_MT_GEN_1_20_GOD_WATERS_BIRDS_SUBJECT', 'EV_MT_GEN_1_20_WATERS_BIRDS', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_20_WATERS_CREATURES_PARTICIPANT', 'EV_MT_GEN_1_20_WATERS_BIRDS', 'SUPPORTS',
         'The claim records waters creatures as directly present in the waters-and-birds statement.'),
        ('CLAIM_MT_GEN_1_20_BIRDS_PARTICIPANT', 'EV_MT_GEN_1_20_WATERS_BIRDS', 'SUPPORTS',
         'The claim records birds as directly present in the waters-and-birds statement.'),
        ('CLAIM_MT_GEN_1_21_GOD_CREATURES_BIRDS_SUBJECT', 'EV_MT_GEN_1_21_CREATURES_BIRDS', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_21_GREAT_SEA_CREATURES_PARTICIPANT', 'EV_MT_GEN_1_21_CREATURES_BIRDS', 'SUPPORTS',
         'The claim records great sea creatures as directly present in the creatures-and-birds statement.'),
        ('CLAIM_MT_GEN_1_21_BIRDS_PARTICIPANT', 'EV_MT_GEN_1_21_CREATURES_BIRDS', 'SUPPORTS',
         'The claim records birds as directly present in the creatures-and-birds statement.'),
        ('CLAIM_MT_GEN_1_22_GOD_WATERS_BIRDS_SUBJECT', 'EV_MT_GEN_1_22_WATERS_BIRDS', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_22_WATERS_CREATURES_PARTICIPANT', 'EV_MT_GEN_1_22_WATERS_BIRDS', 'SUPPORTS',
         'The claim records waters creatures as directly present in the waters-and-birds statement.'),
        ('CLAIM_MT_GEN_1_22_BIRDS_PARTICIPANT', 'EV_MT_GEN_1_22_WATERS_BIRDS', 'SUPPORTS',
         'The claim records birds as directly present in the waters-and-birds statement.'),
        ('CLAIM_MT_GEN_1_23_DAY_BOUNDARY_SUBJECT', 'EV_MT_GEN_1_23_DAY_BOUNDARY', 'SUPPORTS',
         'The claim records the source-presented subject role without asserting the ordinal day count.'),
        ('CLAIM_MT_GEN_1_24_GOD_LAND_CREATURES_SUBJECT', 'EV_MT_GEN_1_24_LAND_CREATURES', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_24_LAND_CREATURES_PARTICIPANT', 'EV_MT_GEN_1_24_LAND_CREATURES', 'SUPPORTS',
         'The claim records land creatures as directly present in the land-creatures statement.'),
        ('CLAIM_MT_GEN_1_25_GOD_LAND_CREATURES_SUBJECT', 'EV_MT_GEN_1_25_LAND_CREATURES', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_25_LAND_CREATURES_PARTICIPANT', 'EV_MT_GEN_1_25_LAND_CREATURES', 'SUPPORTS',
         'The claim records land creatures as directly present in the land-creatures statement.'),
        ('CLAIM_MT_GEN_1_26_GOD_HUMANKIND_SUBJECT', 'EV_MT_GEN_1_26_HUMANKIND', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_26_HUMANKIND_PARTICIPANT', 'EV_MT_GEN_1_26_HUMANKIND', 'SUPPORTS',
         'The claim records humankind as directly present in the humankind statement.'),
        ('CLAIM_MT_GEN_1_27_GOD_HUMANKIND_SUBJECT', 'EV_MT_GEN_1_27_HUMANKIND', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_27_HUMANKIND_PARTICIPANT', 'EV_MT_GEN_1_27_HUMANKIND', 'SUPPORTS',
         'The claim records humankind as directly present in the humankind statement.'),
        ('CLAIM_MT_GEN_1_28_GOD_HUMANKIND_SUBJECT', 'EV_MT_GEN_1_28_HUMANKIND', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_28_HUMANKIND_PARTICIPANT', 'EV_MT_GEN_1_28_HUMANKIND', 'SUPPORTS',
         'The claim records humankind as directly present in the humankind statement.'),
        ('CLAIM_MT_GEN_1_29_GOD_FOOD_PROVISION_SUBJECT', 'EV_MT_GEN_1_29_FOOD_PROVISION', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_29_HUMANKIND_PARTICIPANT', 'EV_MT_GEN_1_29_FOOD_PROVISION', 'SUPPORTS',
         'The claim records humankind as directly present in the food-provision statement.'),
        ('CLAIM_MT_GEN_1_29_VEGETATION_PARTICIPANT', 'EV_MT_GEN_1_29_FOOD_PROVISION', 'SUPPORTS',
         'The claim records vegetation as directly present in the food-provision statement.'),
        ('CLAIM_MT_GEN_1_30_GOD_CREATURE_FOOD_SUBJECT', 'EV_MT_GEN_1_30_CREATURE_FOOD', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_30_LAND_CREATURES_PARTICIPANT', 'EV_MT_GEN_1_30_CREATURE_FOOD', 'SUPPORTS',
         'The claim records land creatures as directly present in the creature-food statement.'),
        ('CLAIM_MT_GEN_1_30_BIRDS_PARTICIPANT', 'EV_MT_GEN_1_30_CREATURE_FOOD', 'SUPPORTS',
         'The claim records birds as directly present in the creature-food statement.'),
        ('CLAIM_MT_GEN_1_30_GREEN_PLANTS_PARTICIPANT', 'EV_MT_GEN_1_30_CREATURE_FOOD', 'SUPPORTS',
         'The claim records green plants as directly present in the creature-food statement.'),
        ('CLAIM_MT_GEN_1_31_GOD_COMPLETION_SUBJECT', 'EV_MT_GEN_1_31_COMPLETION', 'SUPPORTS',
         'The claim records the source-presented subject role.'),
        ('CLAIM_MT_GEN_1_31_ALL_MADE_PARTICIPANT', 'EV_MT_GEN_1_31_COMPLETION', 'SUPPORTS',
         'The claim records all made as directly present in the completion statement.'),
